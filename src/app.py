...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team soccer training and weekend scrimmages",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "brianna@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Drama Club": {
        ...
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["logan@mergington.edu", "avery@mergington.edu"]
    },
    "Math Olympiad": {
